...
var Min = (function () {
    ...
    Min.prototype.setDB = function (dbAddress, options) {
        try {
            options = options || {};
            if (!(0, fs_1.existsSync)(dbAddress)) {
            ...
            if (utils.isString(value)) {
                ...
                for (var _i = 0, _a = Object.keys(value); _i < _a.length; _i++) {
                    ...
                    if (Reflect.has(valueWeights, key_1) || defaultValueWeight > 0) {
                        if (Reflect.has(valueWeights, key_1) && valueWeights[key_1] === 0)
                            continue;
    ...
    Min.indexesPreProcess = function (promise, docId, tokens, ops) {
        return __awaiter(this, void 0, void 0, function () {
            var obj, da;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        da = { type: "put", key: constructIndex(obj["t"]), value: utils.indexOperator.stringifyIndex(obj) };
                        ops.push(da);
                        return [2, Promise.resolve(obj)];
                }
            });
        });
    };
    Min.prototype.create = function (key, value, options) {
        return __awaiter(this, void 0, void 0, function () {
            var docId, tokens, promiseArr, ops, _i, _a, token;
            var _this_1 = this;
                    ...
                    case 3:
                        ...
                        return [4, Promise.all(promiseArr)
                                ...
                                for (var _i = 0, results_2 = results; _i < results_2.length; _i++) {
                                    var obj_1 = results_2[_i];
                                    obj_1["v"] = utils.indexOperator.updateIndexValue(obj_1["v"], docId, 0);
                                    obj_1["l"] = utils.indexOperator.getIndexLength(obj_1["v"]);
                                    if (obj_1["l"] === 0) {
                                        ops.push({ type: "del", key: constructIndex(obj_1["t"]) });
                                    }
                                    else {
                                        ops.push({ type: "put", key: constructIndex(obj_1["t"]), value: utils.indexOperator.stringifyIndex(obj_1) });
                                    }
                                }
    ...
    Min.calTfIdf = function (promise, docCount, docs) {
        return __awaiter(this, void 0, void 0, function () {
            var result, len, idf, tfs, _i, _a, item, pair, docId, tf, tf_norm;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, promise];
                    case 1:
                        ...
                        tfs = result["v"];
                        for (_i = 0, _a = tfs.split(","); _i < _a.length; _i++) {
                            item = _a[_i];
                            pair = item.split(":");
                            docId = pair[0], tf = pair[1];
                            tf_norm = 1 + Math.log1p(tf);
                            docId in docs ? (docs[docId] += idf * tf_norm) : (docs[docId] = idf * tf_norm);
                        }
                        return [2, Promise.resolve(docs)];
                }
            });
        });
    };
    Min.prototype.search = function (content, ops) {
        return __awaiter(this, void 0, void 0, function () {
            var tokens, promiseArr, options, limit, docs, docCount, token, results;
            var _this_1 = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        promiseArr = [];
                        options = ops || { cosineSimilarity: false };
                                            ...
                                            return [4, Promise.all(promiseArr).then(function (res) {
                                                    for (var _i = 0, res_1 = res; _i < res_1.length; _i++) {
                                                        ...
                                                        if (options["cosineSimilarity"]) {
                                                            ...
                                                            var cosValue = 0.01 + Math.abs(utils.cosineSimilarity(tokens, resTokens));
                                                            obj["score"] = Math.sqrt(cosValue) * obj["score"];
                                                        }
                                                    }
                                                    var final = res.sort(function (a, b) {
                                                        return b["score"] - a["score"];
                                                    });
                                                    if (limit && limit < final.length)
                                                        final = final.slice(0, limit - 1);
                                                    return final;
                                                })];
                                        case 1: return [2, _a.sent()];
                                    }
    ...
    Min.prototype.printAll = function () {
        var _a, e_4, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _d, _e, _f, data, e_4_1;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _g.trys.push([0, 5, 6, 11]);
                        _d = true, _e = __asyncValues(this.db.iterator());
                        _g.label = 1;
    ...
    Min.prototype.fixDocCount = function () {
        var _a, e_5, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var docCount, pattern, db, _d, _e, _f, key, e_5_1;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        docCount = 0;
                    ...
                    case 1:
                        ...
                        _d = true, _e = __asyncValues(db.keys({ lte: "0x003_", gte: "0x002_" }));
                        _g.label = 2;
                    case 2: return [4, _e.next()];
                    case 3:
                        if (!(_f = _g.sent(), _a = _f.done, !_a)) return [3, 5];
                        _c = _f.value;
                        _d = false;
                        try {
                            key = _c;
                    ...
                    case 7:
                        ...
                        if (!(!_d && !_a && (_b = _e.return))) return [3, 9];
                        return [4, _b.call(_e)];
                    case 8:
                        _g.sent();
                        _g.label = 9;

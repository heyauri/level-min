  ...
  (0, _createClass2["default"])(Min, [{
    ...
    value: function getTokens(key, value, options) {
      ...
      if (options["keyWeight"]) {
        var _tempTokens = _tokenizer["default"].tokenize(key);
      ...
      if (options["valueWeightCalc"]) {
        ...
        if (utils.isString(value)) {
          tempTokens = _tokenizer["default"].tokenize(value);
          ...
          for (var _i2 = 0, _Object$keys2 = Object.keys(value); _i2 < _Object$keys2.length; _i2++) {
            ...
            if (_key in valueWeights || defaultValueWeight > 0) {
              tempTokens = _tokenizer["default"].tokenize(value[_key]);
          ...
          for (var i = 0; i < value.length; i++) {
            if (i in valueWeights || defaultValueWeight > 0) {
              tempTokens = _tokenizer["default"].tokenize(value[i]);
        ...
        return _regenerator["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                tokens = _tokenizer["default"].tokenize(content);
                promiseArr = [];

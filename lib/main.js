...
function () {
  ...
  (0, _createClass2["default"])(Min, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee10(content, topK, ops) {
        var _this6 = this;

        var tokens, promiseArr, options, _i6, _Object$keys6, token, docCount, results;
      ...
      function search(_x16, _x17, _x18) {

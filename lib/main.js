...
var Min = (function () {
    ...
    Min.prototype.searchIndex = function (token) {
        ...
        return new Promise(function (resolve, reject) {
            _this_1.db.get(constructIndex(token)).then(function (result) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, Promise.all(promiseArr).then(function (results) {
                                var ops = [];
                    ...
                    case 1:
                        ...
                        return [2, new Promise(function (resolve, reject) {
                                ...
                                _this_1.db.batch(ops).then(function (info) {
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [2, new Promise(function (resolve, reject) {
                                ...
                                _this_1.db.batch(ops_1).then(function (info) {
    ...
    Min.calTfIdf = function (promise, docCount, docs) {
        return __awaiter(this, void 0, void 0, function () {
            var result, len, idf, tfs, docId, tf_norm;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        tfs = result["v"];
                        for (docId in tfs) {
                            tf_norm = 1 + Math.log1p(Math.log1p(tfs[docId]));
    ...
    Min.prototype.search = function (content, ops) {
        return __awaiter(this, void 0, void 0, function () {
            var tokens, promiseArr, options, topK, docs, docCount, _i, _a, token, results;
            var _this_1 = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4, Promise.all(promiseArr).then(function (res) { return __awaiter(_this_1, void 0, void 0, function () {
                                var docIds, _i, docIds_1, docId;
                                var _this_1 = this;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            promiseArr = [];
                                            for (_i = 0, docIds_1 = docIds; _i < docIds_1.length; _i++) {
                                                docId = docIds_1[_i];
                                            ...
                                            return [4, Promise.all(promiseArr).then(function (res) {
                                                    ...
                                                    if (topK && topK < final.length)
                                                        final = final.slice(0, topK - 1);
                                                    return final;
                                                })];
                                        case 1: return [2, _a.sent()];
                                    }

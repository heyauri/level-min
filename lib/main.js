  ...
  (0, _createClass2["default"])(Min, [{
    ...
    value: function getTokens(key, value, options) {
      ...
      if (options["keyWeight"]) {
        var _tempTokens = (0, _tokenizer["default"])(key);
      ...
      if (options["valueWeightCalc"]) {
        ...
        if (utils.isString(value)) {
          tempTokens = (0, _tokenizer["default"])(value);
          ...
          for (var _i = 0, _Object$keys = Object.keys(value); _i < _Object$keys.length; _i++) {
            ...
            if (_key in valueWeights || defaultValueWeight > 0) {
              tempTokens = (0, _tokenizer["default"])(value[_key]);
          ...
          for (var i = 0; i < value.length; i++) {
            if (i in valueWeights || defaultValueWeight > 0) {
              tempTokens = (0, _tokenizer["default"])(value[i]);
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee2(key, value, options) {
        ...
        var docId, tokens, promiseArr, _i2, _Object$keys2, token, ops;
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee3(key, value, options, prev_obj) {
        ...
        var docId, tokens, prevTokens, diffTokens, promiseArr, _i3, _Object$keys3, token, ops;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                for (_i3 = 0, _Object$keys3 = Object.keys(diffTokens); _i3 < _Object$keys3.length; _i3++) {
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee5(key) {
        ...
        var docId, docCount, obj, value, options, tokens, promiseArr, _i4, _Object$keys4, token, ops;
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee8(content, topK) {
        ...
        var tokens, promiseArr, _i5, _Object$keys5, token, docCount, results;
              ...
              case 5:
                ...
                function () {
                  ...
                  _regenerator["default"].mark(function _callee7(results) {
                    var docs, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, result, len, idf, tfs, _i6, _Object$keys6, docId, tf_norm, docIds, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _docId;
